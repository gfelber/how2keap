...
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3cdeb640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c22b640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
...
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c4cb640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3cb8b640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c00b640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c90f631};
...
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c00b640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c53b640};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c08e6c1};
...
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c90d231};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c90c931};
filter[idx--] = (struct sock_filter){.code = BPF_LD+BPF_K, .k = 0x3c9090fa};
